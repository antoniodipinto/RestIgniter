...
class Loader
{
	 ...
	 * @var    array
	 */
	protected array $_ci_view_paths = [VIEWPATH => true];
	 ...
	 * @var    array
	 */
	protected array $_ci_library_paths = [APPPATH, BASEPATH];
	 ...
	 * @var    array
	 */
	protected array $_ci_model_paths = [APPPATH];
	 ...
	 * @var    array
	 */
	protected array $_ci_helper_paths = [APPPATH, BASEPATH];
